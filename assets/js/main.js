...
(function ($) {
    ...
    $(function () {
        ...
        // Project Carousel
        var swiperTesti = new Swiper(".project-carousel-2", {
            slidesPerView: 3,
            spaceBetween: 18,
            loop: true,
            autoplay: true,
            ...
            centeredSlides: true,
            pagination: {
                el: ".solera-dot-swiper-pagination",
                clickable: true,
            },
            breakpoints: {
                320: {
        ...
        // Testi Carousel
        var swiperTesti2 = new Swiper(".testi-carousel-3", {
            slidesPerView: 3,
            spaceBetween: 24,
            slidesPerGroup: 1,
            loop: true,
        ...
        // Project Carousel
        var swiperProject = new Swiper(".project-carousel-4", {
            slidesPerView: 3,
            spaceBetween: 40,
            loop: true,
            autoplay: false,
        ...
        var swiperTeam = new Swiper(".team-carousel", {
            ...
            centeredSlides: true,
            navigation: {
                nextEl: '.team-swiper-prev',
                prevEl: '.team-swiper-next',
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
